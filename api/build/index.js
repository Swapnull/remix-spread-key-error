...
var tailwind_default = "/build/_assets/tailwind-JIZ4WSOQ.css";
...
// app/routes/index.tsx
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), import_react = require("react"), someProps = {
  text: "Hello"
}, array = [1, 2, 3, 4, 5];
function Index() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(MyNewComponent, {
        ...someProps,
        color: "red"
      }, void 0, !1, {
      ...
      array.map((item) => /* @__PURE__ */ (0, import_react.createElement)(MyNewComponent, {
        ...someProps,
...
var MyNewComponent = ({ text, color }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
  children: [
    text,
    "-",
    color
...
function LoginPage() {
  var _a, _b, _c, _d;
  let [searchParams] = (0, import_react5.useSearchParams)(), redirectTo = searchParams.get("redirectTo") || "/notes", actionData = (0, import_react5.useActionData)(), emailRef = React.useRef(null), passwordRef = React.useRef(null);
...
function NotesPage() {
  let data = (0, import_react6.useLoaderData)(), user = useUser();
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("header", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react6.Form, {
            action: "/logout",
            method: "post",
...
var import_node7 = require("@remix-run/node"), import_react7 = require("@remix-run/react"), import_tiny_invariant2 = __toESM(require("tiny-invariant"));
var import_jsx_dev_runtime = require("react/jsx-dev-runtime");
...
var import_node8 = require("@remix-run/node"), import_react9 = require("@remix-run/react"), React2 = __toESM(require("react"));
var import_jsx_dev_runtime = require("react/jsx-dev-runtime");
...
function NewNotePage() {
  ...
  let actionData = (0, import_react9.useActionData)(), titleRef = React2.useRef(null), bodyRef = React2.useRef(null);
  ...
  }, [actionData]), /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react9.Form, {
    method: "post",
    style: {
      display: "flex",
...
var import_node9 = require("@remix-run/node"), import_react10 = require("@remix-run/react"), React3 = __toESM(require("react"));
var import_jsx_dev_runtime = require("react/jsx-dev-runtime");
...
function Join() {
  var _a, _b, _c, _d;
  let [searchParams] = (0, import_react10.useSearchParams)(), redirectTo = searchParams.get("redirectTo") ?? void 0, actionData = (0, import_react10.useActionData)(), emailRef = React3.useRef(null), passwordRef = React3.useRef(null);
